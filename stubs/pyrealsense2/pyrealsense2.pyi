...
__all__: list[str] = ['BufData', 'D400', 'D500', 'DEPTH', 'L500', 'SR300', 'STAEControl', 'STAFactor', 'STCensusRadius', 'STColorControl', 'STColorCorrection', 'STDepthControlGroup', 'STDepthTableControl', 'STHdad', 'STRauColorThresholdsControl', 'STRauSupportVectorControl', 'STRsm', 'STSloColorThresholdsControl', 'STSloPenaltyControl', 'T200', 'TRACKING', 'align', 'any', 'any_intel', 'auto_calibrated_device', 'calib_location', 'calib_target_type', 'calibration_change_device', 'calibration_status', 'calibration_type', 'camera_info', 'color_sensor', 'colorizer', 'combined_motion', 'composite_frame', 'config', 'context', 'd500_intercam_sync_mode', 'debug_protocol', 'debug_stream_sensor', 'decimation_filter', 'depth_frame', 'depth_sensor', 'depth_stereo_sensor', 'device', 'device_calibration', 'device_hub', 'device_list', 'disparity_frame', 'disparity_transform', 'distortion', 'embedded_decimation_filter', 'embedded_filter', 'embedded_filter_type', 'embedded_temporal_filter', 'enable_rolling_log_file', 'eth_config_device', 'event_information', 'extension', 'extrinsics', 'filter', 'filter_interface', 'firmware_log_message', 'firmware_log_parsed_message', 'firmware_logger', 'fisheye_sensor', 'format', 'frame', 'frame_metadata_value', 'frame_queue', 'frame_source', 'hdr_merge', 'hole_filling_filter', 'intrinsics', 'ip_address', 'l500_visual_preset', 'labeled_points', 'link_priority', 'log', 'log_message', 'log_severity', 'log_to_callback', 'log_to_console', 'log_to_file', 'matchers', 'max_usable_range_sensor', 'motion_device_intrinsic', 'motion_frame', 'motion_sensor', 'motion_stream', 'motion_stream_profile', 'non_intel', 'notification', 'notification_category', 'option', 'option_from_string', 'option_range', 'option_type', 'option_value', 'options', 'options_list', 'pipeline', 'pipeline_profile', 'pipeline_wrapper', 'playback', 'playback_status', 'pointcloud', 'points', 'pose', 'pose_frame', 'pose_sensor', 'pose_stream', 'pose_stream_profile', 'processing_block', 'product_line', 'quaternion', 'recorder', 'region_of_interest', 'reset_logger', 'roi_sensor', 'rotation_filter', 'rs2_deproject_pixel_to_point', 'rs2_fov', 'rs2_project_color_pixel_to_depth_pixel', 'rs2_project_point_to_pixel', 'rs2_transform_point_to_point', 'rs400_advanced_mode', 'rs400_visual_preset', 'safety_mode', 'safety_sensor', 'save_single_frameset', 'save_to_ply', 'sensor', 'sequence_id_filter', 'serializable_device', 'software_device', 'software_motion_frame', 'software_notification', 'software_pose_frame', 'software_sensor', 'software_video_frame', 'spatial_filter', 'stream', 'stream_profile', 'supports_eth_config', 'sw_only', 'syncer', 'temporal_filter', 'terminal_parser', 'texture_coordinate', 'threshold_filter', 'timestamp_domain', 'units_transform', 'updatable', 'update_device', 'vector', 'vertex', 'video_frame', 'video_stream', 'video_stream_profile', 'wheel_odometer', 'yuy_decoder']
class BufData:
...
class embedded_filter_type:
    ...
    Members:
      ...
      temporal
    """
    __members__: typing.ClassVar[dict[str, embedded_filter_type]]  # value = {'decimation': <embedded_filter_type.decimation: 0>, 'temporal': <embedded_filter_type.temporal: 1>}
...
class option:
    ...
    unknown: typing.ClassVar[option]  # value = <option 106 'UNKNOWN'>
...
class save_to_ply(filter):
    option_ignore_color: typing.ClassVar[option]  # value = <option 116 'UNKNOWN'>
    option_ply_binary: typing.ClassVar[option]  # value = <option 118 'UNKNOWN'>
    option_ply_mesh: typing.ClassVar[option]  # value = <option 117 'UNKNOWN'>
    option_ply_normals: typing.ClassVar[option]  # value = <option 119 'UNKNOWN'>
    option_ply_threshold: typing.ClassVar[option]  # value = <option 120 'UNKNOWN'>
...
class stream:
    ...
    Members:
      ...
      labeled_point_cloud
    """
    __members__: typing.ClassVar[dict[str, stream]]  # value = {'any': <stream.any: 0>, 'depth': <stream.depth: 1>, 'color': <stream.color: 2>, 'infrared': <stream.infrared: 3>, 'fisheye': <stream.fisheye: 4>, 'gyro': <stream.gyro: 5>, 'accel': <stream.accel: 6>, 'gpio': <stream.gpio: 7>, 'pose': <stream.pose: 8>, 'confidence': <stream.confidence: 9>, 'motion': <stream.motion: 10>, 'safety': <stream.safety: 11>, 'occupancy': <stream.occupancy: 12>, 'labeled_point_cloud': <stream.labeled_point_cloud: 13>}
...
__full_version__: str = '2.57.7.10387'
__version__: str = '2.57.7'
